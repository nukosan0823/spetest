# japanese-tech-writingの初版原文

この文書は、`japanese-tech-writing`を改訂する前の原文を、レビューと変更理由の追跡に使える形で保存したものである。
実行時のSkillとしては読み込まず、現行規範との比較にだけ使用する。

- [初版のSKILL.md](https://github.com/nukosan0823/spetest/blob/f0c4514dc6f242b037d4356a3df6dd52eee83fae/.agents/skills/japanese-tech-writing/SKILL.md)
- [現行のSKILL.md](../../.agents/skills/japanese-tech-writing/SKILL.md)
- [初版から現行版への変更](https://github.com/nukosan0823/spetest/compare/f0c4514dc6f242b037d4356a3df6dd52eee83fae...8990639c8e79a7113f5e321496228702b26e2d9c)
- [改訂を行ったPR #2](https://github.com/nukosan0823/spetest/pull/2)
